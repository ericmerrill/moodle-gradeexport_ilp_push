...
class locks {
    ...
    protected static function get_course_submitter_lock($courseid, $submitterid, $timeout = null, $maxlifetime = null) {
        ...
        $lock = self::$factory->get_lock($key, $timeout, $maxlifetime);
